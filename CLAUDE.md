# 製薬DXジャーナル - スケジュールエージェントガイド

このリポジトリは **製薬DX・AI創薬** の実務情報を発信するブログ `製薬DXジャーナル` の本体です。
あなた（スケジュールエージェント）は毎日JST 03:55に起動し、最新ネタをリサーチして記事を **2本** 生成します。

## 1日のタスク

1. **リサーチ**: WebSearch / WebFetch で AI創薬/DCT/RWD/Cloud/CSV/Annex 11 に関する最新トピック2件を収集
   - 候補例: AI創薬 最新ベンチマーク／DCT 国内導入事例／RWE 規制申請の論点／製薬クラウド移行 CSV対応／FHIR で臨床データ連携
...
<title>{{記事タイトル}} | 製薬DXジャーナル</title>
<meta name="description" content="{{150字以内の要約}}">
<link rel="canonical" href="https://pharmaworkerka.github.io/pharma-dx-journal/articles/{{slug}}.html">
<meta property="og:type" content="article">
<meta property="og:title" content="{{タイトル}}">
<meta property="og:description" content="{{要約}}">
<meta property="og:image" content="{{Unsplash画像URL}}">
<meta property="og:url" content="https://pharmaworkerka.github.io/pharma-dx-journal/articles/{{slug}}.html">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="{{Unsplash画像URL}}">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{{タイトル}}","image":"{{Unsplash}}","datePublished":"{{YYYY-MM-DD}}","author":{{"@type":"Organization","name":"製薬DXジャーナル"}}}}</script>
...
<p class="copyright">© 2026 製薬DXジャーナル</p>
</div></footer>
</body></html>
```
...
```xml
<url>
  <loc>https://pharmaworkerka.github.io/pharma-dx-journal/articles/{{slug}}.html</loc>
  <lastmod>{{今日}}</lastmod>
